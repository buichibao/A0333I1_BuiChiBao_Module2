package on_tap.DeThi.service.impl;

import on_tap.DeThi.model.Student;
import on_tap.DeThi.service.IPersonService;
import on_tap.DeThi.utils.ReadWriteFileStudent;
...
public class StudentService implements IPersonService, Comparator<Student> {
    ...
    private static final String PATH = "src\\on_tap\\DeThi\\data\\student.csv";
